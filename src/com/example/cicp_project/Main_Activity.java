...
import NFC.NFC_Class;//For NFC
import android.graphics.Bitmap;//For load img
import android.widget.ImageView;//For load img
import android.app.ProgressDialog;//For load img
import android.graphics.BitmapFactory;//For load img
import java.net.HttpURLConnection;
import java.net.URL;//For load img
